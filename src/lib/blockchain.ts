...
/**
 * Generiše MetaMask deep link koji vodi na trenutnu stranicu.
 * Na mobilnom uređaju otvara MetaMask in-app browser gde
 * window.ethereum postoji i transakcije mogu biti potpisane.
 */
